...
++ `econperc` = .4 and `lostjob` = 0. ++ `econperc` = .6 and `lostjob` = 0. ++ `econperc` = .4 and `lostjob` = 1. ++ `econperc` = .6 and `lostjob` = 1.
